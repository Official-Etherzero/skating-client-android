...
public class BtcConfiguration {
    ...
    private static final Logger log = LoggerFactory.getLogger(BtcConfiguration.class);

    public BtcConfiguration(final SharedPreferences prefs, final Resources res) {
        this.prefs = prefs;
        this.res = res;
    ...
    public Uri getBlockExplorer() {
        return Uri.parse(prefs.getString(PREFS_KEY_BLOCK_EXPLORER,"https://www.blockchain.com/btctest/"));
    }
