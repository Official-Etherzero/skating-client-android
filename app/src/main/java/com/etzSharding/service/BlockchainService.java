...
package com.etzSharding.service;
...
import com.etzSharding.blockchain.BtcConfiguration;
import com.etzSharding.blockchain.data.ExchangeRate;
import com.etzSharding.blockchain.data.TimeLiveData;
import com.etzSharding.blockchain.data.WalletBalanceLiveData;
import com.etzSharding.blockchain.data.WalletLiveData;
import com.etzSharding.blockchain.walletutils.BtcWalletUtil;
...
public class BlockchainService extends LifecycleService {
    ...
    private BtcConfiguration config;
//    private AddressBookDao addressBookDao;
    ...
    public static void scheduleStart(final MyApp application) {
        final BtcConfiguration config = application.getConfiguration();
...
//    private void notifyCoinsReceived( final Address address, final Coin amount,
...
//    }
    ...
    private final class PeerConnectivityListener
        ...
        public void onSharedPreferenceChanged(final SharedPreferences sharedPreferences, final String key) {
            if (BtcConfiguration.PREFS_KEY_CONNECTIVITY_NOTIFICATION.equals(key))
                changed(peerCount);
        }
...
//
//        public ImpedimentsLiveData(final MyApp application) {
...
//        addressBookDao = AppDatabase.getDatabase(application).addressBookDao();
        ...
        wallet.observe(this, new Observer<Wallet>() {
            ...
            public void onChanged(final Wallet wallet) {
                ...
                try {
                    blockStore = new SPVBlockStore(BtcWalletUtil.getParams(), blockChainFile,
                    ...
                    if (!blockChainFileExists && earliestKeyCreationTime > 0) {
                        try {
                            ...
                            CheckpointManager.checkpoint(BtcWalletUtil.getParams(), checkpointsInputStream,
                ...
                try {
                    blockChain = new BlockChain(BtcWalletUtil.getParams(), wallet, blockStore);
                } catch (final BlockStoreException x) {
        ...
        newTransaction.observe(this, new Observer<Transaction>() {
            ...
            public void onChanged(final Transaction tx) {
                ...
                if (amount.isPositive()) {
                    final Address address = BtcWalletUtil.getWalletAddressOfReceived(tx, wallet);
...
//                    CrashReporter.saveBackgroundTrace(new RuntimeException(message), application.packageInfo());
                ...
                peerGroup = new PeerGroup(BtcWalletUtil.getParams(), blockChain);
                ...
                peerGroup.addPeerDiscovery(new PeerDiscovery() {
                    private final PeerDiscovery normalPeerDiscovery = MultiplexingDiscovery
                            .forServices(BtcWalletUtil.getParams(), 0);
                    ...
                    public InetSocketAddress[] getPeers(final long services, final long timeoutValue,
                        ...
                        if (hasTrustedPeer) {
                            ...
                            final InetSocketAddress addr = new InetSocketAddress(trustedPeerHost,
                                    BtcWalletUtil.getParams().getPort());
