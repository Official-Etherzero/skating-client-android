...
//                    return getSystemLocale(context);
    ...
    public static List<languageEntity> getLanguageList(Context context) {
        ...
        if (lid == 0) {
            ...
            languageEntities.add(new languageEntity(1, "中文（简体）", lang.equalsIgnoreCase("zh")));
            languageEntities.add(new languageEntity(7, "中文（繁体）", false));
            languageEntities.add(new languageEntity(2, "English", lang.equalsIgnoreCase("en")));

        } else {
            languageEntities.add(new languageEntity(1, "中文（简体）", lid == 1));
            languageEntities.add(new languageEntity(7, "中文（繁体）", lid == 7));
            languageEntities.add(new languageEntity(2, "English", lid == 2));
        }
