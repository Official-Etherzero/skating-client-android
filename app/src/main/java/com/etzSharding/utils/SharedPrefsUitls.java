...
public class SharedPrefsUitls {
    ...
    public int getFiatCurrency() {
        return mSharedPreferences.getInt("BiId", 1);
    }

    public void putFiatCurrency(int biid) {
        SharedPreferences.Editor edit = mSharedPreferences.edit();
        edit.putInt("BiId", biid);
        edit.apply();
    }
    ...
    public String getCurrentAccount() {
        return mSharedPreferences.getString(CURRENT_ACCOUNT, "");
    }

    public void putCurrentWallet(String wid) {
        SharedPreferences.Editor edit = mSharedPreferences.edit();
        String account = getCurrentAccount();
        edit.putString(account, wid);
        edit.apply();
    }

    public String getCurrentWallet() {
        String account = getCurrentAccount();
        if (Util.isNullOrEmpty(account)) return "";
...
//        }
    ...
    public void putETZAddress(String address) {
        SharedPreferences.Editor editor = mSharedPreferences.edit();
        editor.putString("ETZAddress", address);
        editor.apply();
    }

    public String getETZAddress() {
        return mSharedPreferences.getString("ETZAddress", "");
    }

    public void putIsActiveUsdtAddress(boolean isActive) {
        SharedPreferences.Editor editor = mSharedPreferences.edit();
        editor.putBoolean("ActiveUsdt", isActive);
        editor.apply();
    }

    public String isActiveUsdtAddress() {
        return mSharedPreferences.getString("ActiveUsdt", "");
    }
