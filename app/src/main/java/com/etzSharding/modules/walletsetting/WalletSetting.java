package com.etzSharding.modules.walletsetting;
...
import com.etzSharding.modules.walletsetting.exportKeystore.ExportKeystoreActivity;
import com.etzSharding.modules.walletsetting.updatePassword.UpdatePasswordActivity;
...
import com.etzSharding.view.DeleteWalletDialog;
import com.etzSharding.view.InputPwdDialog;
import com.etzSharding.view.MEdit;
import com.etzSharding.view.MText;
import com.etzSharding.view.PrivateKeyDerivetDialog;
...
//        setWalletIcon.setImageResource(iconResourceId);
        ...
        if (balances.containsKey("ETZ")) {
            String cryptoBalance = CurrencyUtils.getFormattedAmount(this, "ETZ", new BigDecimal(Util.isNullOrEmpty(balances.get("ETZ")) ? "0" : balances.get("ETZ")));
            setWalletName.setText(cryptoBalance);
        } else {
            setWalletName.setText("0 ETZ");
        }
