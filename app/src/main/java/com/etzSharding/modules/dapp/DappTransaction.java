...
import com.etzSharding.modules.WebViewActivity;
...
import com.etzSharding.modules.walletoperation.send.InputPwdView;
...
public class DappTransaction extends BaseActivity<DappTransactionView, DappTransactionPresenter> implements DappTransactionView {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.dapp_send_button:
                ...
                BalanceEntity be = BalanceDataSource.getInstance().getTokenBalance("ETZ", SharedPrefsUitls.getInstance().getCurrentWallet());
                ...
                String content = rawAddress + "\n\n" + getString(R.string.Confirmation_amountLabel) + amount + "(ETZ)\n" + getString(R.string.Confirmation_feeLabel) + kgf + "(ETZ)\n";
    ...
    public void onError(String err) {
        MyLog.i("onError-------" + err);
//        ETZDialog.showSimpleDialog(DappTransaction.this, getString(R.string.WipeWallet_failedTitle), err);
    }
    ...
    private void onSuccessTransaction(String transaction) {
        ...
        Token token = new Token(new TokenInfo(wallet.getAddress(), "EtherZero", "ETZ", "",
